...
<script setup lang="ts">
  ...
  const aiTpl = {
    ...
    name: '行程定制',
    avatar:
      'https://lf26-appstore-sign.oceancloudapi.com/ocean-cloud-tos/FileBizType.BIZ_BOT_ICON/default_bot_icon6.png?lk3s=50ccb0c5&x-expires=1723273049&x-signature=SyVr3B54Kq4tambyROFqljCcL1o%3D',
    content: '',
    date: '',
    followUp: [],
  }
